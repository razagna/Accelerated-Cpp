#  1. Overview
The content of this repository is based on the book **Accelerated C++: Practical Programming by Example** by _Andrew Koenig and Barbara E. Moo_. It mainly consists of:
...
The original book can be found [here](https://www.amazon.com/Accelerated-C-Practical-Programming-Example/dp/020170353X).
